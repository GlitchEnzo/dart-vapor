...
([
["LongJump", "longjump.dart", , A, {
  "": "",
  main: [function() {
    var t1, t2, t3, e, cameraObject, camera, carPiece1, carPiece1Collider, carPiece2, carPiece2Collider, wheel1Joint, wheel2Joint, follow, rampObject, ramp;
    t1 = document.querySelector("#reset");
    t1.toString;
    t2 = C.EventStreamProvider_click._eventType;
    t1 = H.setRuntimeTypeInfo(new W._ElementEventStreamImpl(t1, t2, false), [null]);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(A.onResetClicked$closure()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    t1 = document.querySelector("#reset");
    t1.toString;
    ...
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(A.onFullscreenClicked$closure()), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
    t2 = document.querySelector("#fullscreen");
    t2.toString;
    t3 = H.setRuntimeTypeInfo(new W._ElementEventStreamImpl(t2, t3, false), [null]);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t3._target, t3._eventType, W._wrapZone(A.onFullscreenClicked$closure()), t3._useCapture), [H.getTypeArgumentByIndex(t3, 0)])._tryResume$0();
    t3 = new Float32Array(2);
    t3[0] = 0;
    t3[1] = -9.8;
    t3 = new Q.Scene("New Scene", [], [], false, null, null, new T.Vector2(t3));
    t3.Scene$FromCanvas$2(Q.Canvas$(), null);
    $.scene = t3;
    $.whiteMaterial = Q.Material$(Q.Shader_FromFile("../shaders/white.glsl"));
    t3 = Q.Material$(Q.Shader_FromFile("../shaders/colored.glsl"));
    $.blueMaterial = t3;
    t3.SetVector$2("uMainColor", $.get$Color_Blue());
    t3 = Q.Material$(Q.Shader_FromFile("../shaders/colored.glsl"));
    $.greenMaterial = t3;
    t3.SetVector$2("uMainColor", $.get$Color_Green());
    ...
    $.checkerboard = t1;
    t1.LoadedCallback = A.LoadedCallback$closure();
    t1 = $.scene;
    C.JSArray_methods.set$length(t1.gameObjects, 0);
    t1.world = V.World$(t1._gravity, true, V.DefaultWorldPool$());
    cameraObject = new Q.GameObject("GameObject", [], [], null, null, null, null, null, null, null);
    t1 = Q.Transform$();
    cameraObject.transform = t1;
    cameraObject.AddComponent$1(t1);
    cameraObject.name = "Camera";
    camera = new Q.Camera("Camera", $.get$Color_UnityBlue(), 45, null, 0.1, 1000, null, "Component", true, null);
    camera.Camera$0();
    cameraObject.AddComponent$1(camera);
    t1 = cameraObject.transform;
    t2 = new T.Vector3(new Float32Array(3));
    t2.setValues$3(0, 0, -15);
    t1.set$position(t1, t2);
    cameraObject.camera.backgroundColor = $.get$Color_CornflowerBlue();
    $.scene.AddGameObject$1(cameraObject);
    t2 = Q.GameObject_CreateQuad();
    $.carObject = t2;
    t2.name = "carObject";
    t1 = new Q.RigidBody("RigidBody", null, 2, null, "Component", true, null);
    t1._bodyType = 2;
    t2.AddComponent$1(t1);
    t1 = $.carObject;
    ...
    t3[0] = 1;
    t3[1] = 1;
    t1.AddComponent$1(new Q.BoxCollider("BoxCollider", new T.Vector2(t2), new T.Vector2(t3), "Collider", null, false, null, null, "Component", true, null));
    $.carObject.AddComponent$1(new A.Car(0, 0, "Component", true, null));
    t3 = $.carObject;
    t3.renderer.material = $.blueMaterial;
    t3 = t3.transform;
    t2 = new T.Vector3(new Float32Array(3));
    t2.setValues$3(5, 3, 0);
    t3.set$position(t3, t2);
    $.scene.AddGameObject$1($.carObject);
    carPiece1 = Q.GameObject_CreateQuad();
    ...
    t3[0] = 1;
    t3[1] = 1;
    carPiece1Collider = new Q.BoxCollider("BoxCollider", new T.Vector2(t2), new T.Vector2(t3), "Collider", null, false, null, null, "Component", true, null);
    t3 = new Float32Array(2);
    t3[0] = 1;
    t3[1] = 0;
    carPiece1Collider.center = new T.Vector2(t3);
    carPiece1.AddComponent$1(carPiece1Collider);
    carPiece1.renderer.material = $.whiteMaterial;
    t3 = $.carObject;
    t3.toString;
    carPiece1.parent = t3;
    t3.children.push(carPiece1);
    $.scene.AddGameObject$1(carPiece1);
    carPiece2 = Q.GameObject_CreateQuad();
    ...
    t2[0] = 1;
    t2[1] = 1;
    carPiece2Collider = new Q.BoxCollider("BoxCollider", new T.Vector2(t3), new T.Vector2(t2), "Collider", null, false, null, null, "Component", true, null);
    t2 = new Float32Array(2);
    t2[0] = 2;
    t2[1] = 0;
    carPiece2Collider.center = new T.Vector2(t2);
    carPiece2.AddComponent$1(carPiece2Collider);
    carPiece2.renderer.material = $.blueMaterial;
    t2 = $.carObject;
    t2.toString;
    carPiece2.parent = t2;
    t2.children.push(carPiece2);
    $.scene.AddGameObject$1(carPiece2);
    t2 = Q.GameObject_CreateCircle(0.5, 15, 0, 6.283185307179586);
    $.wheel1 = t2;
    t2.name = "wheel1";
    t3 = new Q.RigidBody("RigidBody", null, 2, null, "Component", true, null);
    t3._bodyType = 2;
    t2.AddComponent$1(t3);
    t3 = $.wheel1;
    t2 = new Float32Array(2);
    t2[0] = 0;
    t2[1] = 0;
    t2 = new Q.CircleCollider("CircleCollider", new T.Vector2(t2), 1, "Collider", null, false, null, null, "Component", true, null);
    t2.radius = 0.5;
    t3.AddComponent$1(t2);
    t2 = $.wheel1;
    t2.renderer.material = $.whiteMaterial;
    t2 = t2.transform;
    t3 = new T.Vector3(new Float32Array(3));
    t3.setValues$3(5, 2, 0);
    t2.set$position(t2, t3);
    wheel1Joint = new Q.RevoluteJoint("RevoluteJoint", 1, null, false, null, null, null, "Component", true, null);
    wheel1Joint.connectedRigidBody = $.carObject.rigidbody;
    t3 = $.wheel1.transform;
    t3 = t3.get$position(t3).storage;
    t2 = t3[0];
    t3 = t3[1];
    t1 = new Float32Array(2);
    t1[0] = t2;
    t1[1] = t3;
    wheel1Joint.anchor = new T.Vector2(t1);
    $.wheel1.AddComponent$1(wheel1Joint);
    $.scene.AddGameObject$1($.wheel1);
    t1 = Q.GameObject_CreateCircle(0.5, 15, 0, 6.283185307179586);
    $.wheel2 = t1;
    t1.name = "wheel2";
    t3 = new Q.RigidBody("RigidBody", null, 2, null, "Component", true, null);
    t3._bodyType = 2;
    t1.AddComponent$1(t3);
    t3 = $.wheel2;
    t1 = new Float32Array(2);
    t1[0] = 0;
    t1[1] = 0;
    t1 = new Q.CircleCollider("CircleCollider", new T.Vector2(t1), 1, "Collider", null, false, null, null, "Component", true, null);
    t1.radius = 0.5;
    t3.AddComponent$1(t1);
    t1 = $.wheel2;
    t1.renderer.material = $.whiteMaterial;
    t1 = t1.transform;
    t3 = new T.Vector3(new Float32Array(3));
    t3.setValues$3(7, 2, 0);
    t1.set$position(t1, t3);
    wheel2Joint = new Q.RevoluteJoint("RevoluteJoint", 1, null, false, null, null, null, "Component", true, null);
    ...
    t2[0] = t1;
    t2[1] = t3;
    wheel2Joint.anchor = new T.Vector2(t2);
    $.wheel2.AddComponent$1(wheel2Joint);
    $.scene.AddGameObject$1($.wheel2);
    A.BuildMarkers(50);
    A.BuildGround(10);
    follow = new A.FollowObject(null, "Component", true, null);
    follow.target = carPiece1;
    cameraObject.AddComponent$1(follow);
    rampObject = Q.GameObject_CreateQuad();
    rampObject.renderer.material = $.checkerboardMaterial;
    t2 = rampObject.transform;
    t3 = new T.Vector3(new Float32Array(3));
    t3.setValues$3(0, 0.5, 0);
    t2.set$position(t2, t3);
    t3 = rampObject.transform;
    t2 = new T.Vector3(new Float32Array(3));
    t2.setValues$3(3, 1, 1);
    t3._scale = t2;
    t3 = t3._scaleMatrix;
    t3.scale$1(t3, t2);
    t2 = rampObject.transform;
    t3 = new T.Vector3(new Float32Array(3));
    t3.setValues$3(0, 0, -0.5235987755982988);
    t2.set$eulerAngles(t3);
    t3 = new Q.RigidBody("RigidBody", null, 2, null, "Component", true, null);
    t3._bodyType = 0;
    rampObject.AddComponent$1(t3);
    t3 = new Float32Array(2);
    t3[0] = 0;
    t3[1] = 0;
    t2 = new Float32Array(2);
    t2[0] = 1;
    t2[1] = 1;
    ramp = new Q.BoxCollider("BoxCollider", new T.Vector2(t3), new T.Vector2(t2), "Collider", null, false, null, null, "Component", true, null);
    t2 = rampObject.transform._scale.storage;
    t3 = t2[0];
    t2 = t2[1];
    t1 = new Float32Array(2);
    t1[0] = t3;
    t1[1] = t2;
    ramp.size = new T.Vector2(t1);
    rampObject.AddComponent$1(ramp);
    $.scene.AddGameObject$1(rampObject);
  ...
  onResetClicked: [function($event) {
    var t1, t2;
    t1 = $.carObject.transform;
    t2 = new T.Vector3(new Float32Array(3));
    t2.setValues$3(5, 3, 0);
    t1.set$position(t1, t2);
    $.carObject.rigidbody.body.set$awake(true);
    t2 = $.wheel1.transform;
    t1 = new T.Vector3(new Float32Array(3));
    t1.setValues$3(5, 2, 0);
    t2.set$position(t2, t1);
    t1 = $.wheel2.transform;
    t2 = new T.Vector3(new Float32Array(3));
    t2.setValues$3(7, 2, 0);
    t1.set$position(t1, t2);
  }, "call$1", "onResetClicked$closure", 2, 0, 2],
  BuildGround: function(groundPieces) {
    var leftWallObject, t1, t2, leftWall, t3, i, groundObject, ground1;
    leftWallObject = Q.GameObject_CreateQuad();
    leftWallObject.renderer.material = $.greenMaterial;
    t1 = leftWallObject.transform;
    t2 = new T.Vector3(new Float32Array(3));
    t2.setValues$3(40, 50, 0);
    t1.set$position(t1, t2);
    t2 = leftWallObject.transform;
    t1 = new T.Vector3(new Float32Array(3));
    t1.setValues$3(1, 100, 1);
    t2._scale = t1;
    t2 = t2._scaleMatrix;
    t2.scale$1(t2, t1);
    t1 = new Q.RigidBody("RigidBody", null, 2, null, "Component", true, null);
    t1._bodyType = 0;
    leftWallObject.AddComponent$1(t1);
    t1 = new Float32Array(2);
    t1[0] = 0;
    t1[1] = 0;
    t2 = new Float32Array(2);
    t2[0] = 1;
    t2[1] = 1;
    leftWall = new Q.BoxCollider("BoxCollider", new T.Vector2(t1), new T.Vector2(t2), "Collider", null, false, null, null, "Component", true, null);
    t2 = leftWallObject.transform._scale.storage;
    t1 = t2[0];
    t2 = t2[1];
    t3 = new Float32Array(2);
    t3[0] = t1;
    t3[1] = t2;
    leftWall.size = new T.Vector2(t3);
    leftWallObject.AddComponent$1(leftWall);
    $.scene.AddGameObject$1(leftWallObject);
    for (i = 0; i < groundPieces; ++i) {
      groundObject = Q.GameObject_CreateQuad();
      groundObject.renderer.material = $.greenMaterial;
      t1 = groundObject.transform;
      ...
      t1 = t1._scaleMatrix;
      t1.scale$1(t1, t3);
      t3 = groundObject.transform;
      t1 = t3._scale.storage[0];
      t2 = new Float32Array(3);
      t2[0] = -(t1 / 2) + 40 - i * t1;
      t2[1] = 0;
      t2[2] = 0;
      t3.set$position(t3, new T.Vector3(t2));
      t2 = new Q.RigidBody("RigidBody", null, 2, null, "Component", true, null);
      t2._bodyType = 0;
      groundObject.AddComponent$1(t2);
      t2 = new Float32Array(2);
      t2[0] = 0;
      t2[1] = 0;
      t3 = new Float32Array(2);
      t3[0] = 1;
      t3[1] = 1;
      ground1 = new Q.BoxCollider("BoxCollider", new T.Vector2(t2), new T.Vector2(t3), "Collider", null, false, null, null, "Component", true, null);
      t3 = groundObject.transform._scale.storage;
      t2 = t3[0];
      t3 = t3[1];
      t1 = new Float32Array(2);
      t1[0] = t2;
      t1[1] = t3;
      ground1.size = new T.Vector2(t1);
      groundObject.AddComponent$1(ground1);
      $.scene.AddGameObject$1(groundObject);
    }
  },
  BuildMarkers: function(numMarkers) {
    var i, markerObject, t1, t2, t3;
    for (i = 0; i < numMarkers; ++i) {
      markerObject = Q.GameObject_CreateQuad();
      markerObject.renderer.material = $.whiteMaterial;
      t1 = markerObject.transform;
      t2 = new Float32Array(3);
      t3 = new T.Vector3(t2);
      t2[0] = 0.1;
      t2[1] = 5;
      ...
      t1 = t1._scaleMatrix;
      t1.scale$1(t1, t3);
      t3 = markerObject.transform;
      t1 = new Float32Array(3);
      t1[0] = -10 - i * 10;
      t1[1] = 0;
      t1[2] = 0;
      t3.set$position(t3, new T.Vector3(t1));
      $.scene.AddGameObject$1(markerObject);
    }
  },
  Car: {
    "": "Component;distance,maxDistance,name,enabled,gameObject",
    Update$0: function() {
      var t1, t2;
      if (this.distance <= 1) {
        if ($.get$Keyboard__currentFrame().containsKey$1(39)) {
          t1 = $.get$Keyboard__currentFrame();
          t1 = t1.$index(t1, 39) === true;
        } else
          t1 = false;
        if (!t1)
          if ($.get$Keyboard__currentFrame().containsKey$1(68)) {
            t1 = $.get$Keyboard__currentFrame();
            t1 = t1.$index(t1, 68) === true;
          } else
            t1 = false;
        else
          t1 = true;
        if (t1) {
          t1 = this.gameObject.rigidbody.body;
          t2 = new Float32Array(2);
          t2[0] = -3;
          t2[1] = 0;
          t1.applyForce$2(new T.Vector2(t2), this.gameObject.rigidbody.body.sweep.center);
        }
        if ($.get$Keyboard__currentFrame().containsKey$1(37)) {
          t1 = $.get$Keyboard__currentFrame();
          t1 = t1.$index(t1, 37) === true;
        } else
          t1 = false;
        if (!t1)
          if ($.get$Keyboard__currentFrame().containsKey$1(65)) {
            t1 = $.get$Keyboard__currentFrame();
            t1 = t1.$index(t1, 65) === true;
          } else
            t1 = false;
        else
          t1 = true;
      ...
      t1 = this.gameObject.transform;
      this.distance = -t1.get$position(t1).storage[0];
      document.querySelector("#distance").textContent = C.JSNumber_methods.toStringAsFixed$1(this.distance, 2) + " meters";
      t1 = this.distance;
      if (t1 > this.maxDistance) {
        this.maxDistance = t1;
        document.querySelector("#max").textContent = C.JSNumber_methods.toStringAsFixed$1(this.maxDistance, 2) + " meters";
      }
    }
  },
  FollowObject: {
    "": "Component;target,name,enabled,gameObject",
    Update$0: function() {
      var t1, t2, t3, t4, t5;
      t1 = this.gameObject.transform;
      t2 = this.target.transform;
      t2 = t2.get$position(t2).storage[0];
      t3 = this.target.transform;
      t3 = t3.get$position(t3).storage[1];
      t4 = this.gameObject.transform;
      t5 = new T.Vector3(new Float32Array(3));
      t5.setValues$3(t2, t3 + 4, t4.get$position(t4).storage[2]);
      t1.set$position(t1, t5);
    }
  }
},
1],
...
["_isolate_helper", "dart:_isolate_helper", , H, {
  ...
  IsolateNatives__processWorkerMessage_closure: {
    "": "Closure:14;entryPoint_0,args_1,message_2,isSpawnUri_3,replyTo_4",
    call$0: function() {
...
["box2d", "package:box2d/box2d.dart", , V, {
  ...
  Transform0: {
    ...
    static: {Transform$0: function() {
        return new V.Transform0(new T.Vector2(new Float32Array(2)), new T.Matrix2(new Float32Array(4)));
      }, Transform_mul: function($T, v) {
        var t1, t2, t3, t4, t5, t6, t7, t8, t9;
        t1 = $T.position.storage;
        t2 = t1[0];
        t3 = $T.rotation.storage;
        t4 = t3[0];
        t5 = v.storage;
        t6 = t5[0];
        t7 = t3[2];
  ...
  Body: {
    ...
    resetMassData$0: function() {
      ...
      for (f = this.fixtureList; f != null; f = f.next) {
        ...
        if (t4 === 0)
          continue;
        f.shape.computeMass$2(massData, t4);
  ...
  ContactSolver: {
    ...
    solveVelocityConstraints$0: function() {
      ...
      while (true) {
        ...
        if (t20 === 1) {
          ...
          t20 = a1.storage;
          t5[0] = t22 * t17[1] + t18[0] - t19[0] + wA * t20[1];
          t5[1] = wB * t17[0] + t18[1] - t19[1] - wA * t20[0];
          t20 = t5[0];
          t17 = t16[0];
          t22 = t5[1];
          t16 = t16[1];
          t21 = ccp.get$normalMass();
          t23 = ccp.velocityBias;
          t24 = ccp.normalImpulse;
          a = t24 + -t21 * (t20 * t17 + t22 * t16 - t23);
          newImpulse = a > 0 ? a : 0;
          ...
          t21[1] = t20;
          t20 = ccp.rA.storage;
          t1[0] = t22 * ccp.get$rB().storage[1] + t18[0] - t19[0] + wA * t20[1];
          t17 = ccp.rB.storage;
          t1[1] = wB * t17[0] + t18[1] - t19[1] - wA * t20[0];
          t23 = cp2.rA.storage;
          t2[0] = t22 * cp2.get$rB().storage[1] + t18[0] - t19[0] + wA * t23[1];
          t22 = cp2.rB.storage;
          t2[1] = wB * t22[0] + t18[1] - t19[1] - wA * t23[0];
          t24 = t1[0];
          t25 = t16[0];
          t26 = t1[1];
          t27 = t16[1];
          ...
          $loop$1: {
            ...
            if (t21 >= 0 && t8[1] >= 0) {
              ...
              t23 = t23[1];
              t27 = t13[0];
              wA -= invIA * (t16 * t21 - t20 * t24 + (t25 * t26 - t23 * t27));
              wB += invIB * (t17[0] * t21 - t17[1] * t24 + (t22[0] * t26 - t22[1] * t27));
            ...
            if (vn1 >= 0 && vn2 >= 0) {
              ...
              t23 = t23[1];
              t26 = t13[0];
              wA -= invIA * (t16 * t17 - t20 * t21 + (t24 * t25 - t23 * t26));
              wB += invIB * (t24 * t17 - t23 * t21 + (t22[0] * t25 - t22[1] * t26));
              ccp.normalImpulse = t8[0];
              cp2.normalImpulse = t8[1];
              break $loop$1;
            }
        ...
        t16 = bodyA._linearVelocity.storage;
        t16[1] = t19[1];
        t16[0] = t19[0];
        if (bodyA._type !== 0) {
          if (wA * wA > 0)
        ...
        t16 = bodyB._linearVelocity.storage;
        t16[1] = t18[1];
        t16[0] = t18[0];
        if (bodyB._type !== 0) {
          if (wB * wB > 0)
    ...
    solvePositionConstraints$1: function(baumgarte) {
      var t1, t2, t3, t4, t5, t6, t7, psm, t8, t9, t10, t11, t12, t13, t14, t15, t16, t17, t18, t19, t20, minSeparation, i, t21, c, bodyA, bodyB, invMassA, invIA, invMassB, invIB, t22, t23, t24, t25, j, t26, t27, separation, $C, t28, t29, rnA, rnB, $K, impulse;
      t1 = this.P.storage;
      t2 = this.temp1;
      t3 = t2.storage;
      t4 = this.rA;
        ...
        for (t21 = bodyA.sweep, t22 = t21.center, t23 = bodyB.sweep, t24 = t23.center, t25 = J.getInterceptor$ns(invMassA), j = 0; j < c.get$pointCount(); ++j) {
          switch (c.get$type(c)) {
            ...
            case 1:
              ...
              t26 = t26.originTransform.rotation;
              t27 = t27.storage;
              t16[1] = t27[1];
              t16[0] = t27[0];
              t26.transform$1(t26, t13);
              t26 = c.get$bodyA();
              t27 = c.get$localPoint();
              V.Transform_mulToOut(t26.originTransform, t27, t8);
              t27 = c.get$bodyB();
              t26 = c.get$points(c);
              if (j >= t26.length)
                return H.ioore(t26, j);
              t26 = t26[j].get$localPoint();
              V.Transform_mulToOut(t27.originTransform, t26, t9);
              t11[1] = t12[1];
              t11[0] = t12[0];
              t10.sub$1(t8);
              t26 = t10.dot$1(t13);
  ...
  TimeOfImpactSolver: {
    ...
    solve$1: function(baumgarte) {
      var t1, t2, t3, t4, t5, t6, t7, t8, normal, point, t9, t10, t11, t12, t13, t14, t15, t16, t17, t18, t19, minSeparation, i, t20, c, bodyA, bodyB, massA, massB, invMassA, invIA, invMassB, invIB, t21, t22, t23, t24, t25, t26, j, t27, t28, t29, separation, $C, t30, rnA, rnB, $K, impulse;
      for (t1 = this.P.storage, t2 = this.temp, t3 = t2.storage, t4 = this.rA, t5 = t4.storage, t6 = this.rB, t7 = t6.storage, t8 = this.psm, normal = t8.normal, point = t8.point, t9 = point.storage, t10 = normal.storage, t11 = t8.planePoint, t12 = t11.storage, t13 = t8.clipPoint.storage, t14 = t8.temp, t15 = t14.storage, t16 = t8.pointA, t17 = t16.storage, t18 = t8.pointB, t19 = t18.storage, minSeparation = 0, i = 0; i < this.count; ++i) {
        ...
        if (bodyA == null ? t20 == null : bodyA === t20)
          ...
          massA = 0;
        t20 = J.getInterceptor$n(massA);
        invMassA = t20.$mul(massA, bodyA.get$invMass());
        invIA = t20.$mul(massA, bodyA.invInertia);
        t20 = J.getInterceptor$n(massB);
        invMassB = t20.$mul(massB, bodyB.get$invMass());
        invIB = t20.$mul(massB, bodyB.invInertia);
        for (t20 = bodyA.sweep, t21 = t20.center, t22 = J.getInterceptor$n(invIA), t23 = bodyB.sweep, t24 = t23.center, t25 = J.getInterceptor$n(invIB), t26 = J.getInterceptor$ns(invMassA), j = 0; j < c.get$pointCount(); ++j) {
          switch (c.get$type(c)) {
            case 0:
              t27 = c.get$bodyA();
              t28 = c.get$localPoint();
              t27.toString;
              t29 = new Float32Array(2);
              V.Transform_mulToOut(t27.originTransform, t28, new T.Vector2(t29));
              t17[1] = t29[1];
              t17[0] = t29[0];
              t29 = c.get$bodyB();
              t28 = c.get$localPoints();
              if (0 >= t28.length)
                return H.ioore(t28, 0);
              t28 = t28[0];
              t29.toString;
              t27 = new Float32Array(2);
              V.Transform_mulToOut(t29.originTransform, t28, new T.Vector2(t27));
              t19[1] = t27[1];
              t19[0] = t27[0];
              ...
              t9[1] = t17[1];
              t9[0] = t17[0];
              t27 = point.add$1(point, t18).storage;
              t27[1] = t27[1] * 0.5;
              t27[0] = t27[0] * 0.5;
              t15[1] = t19[1];
              t15[0] = t19[0];
            ...
            case 1:
              t27 = c.get$bodyA();
              t28 = c.get$localNormal();
              t27.toString;
              t29 = new Float32Array(2);
              t27 = t27.originTransform.rotation;
              t28 = t28.storage;
              t29[1] = t28[1];
              t29[0] = t28[0];
              t27.transform$1(t27, new T.Vector2(t29));
              t10[1] = t29[1];
              t10[0] = t29[0];
              t27 = c.get$bodyA();
              t28 = c.get$localPoint();
          ...
          $K = J.$add$ns(J.$add$ns(t26.$add(invMassA, invMassB), J.$mul$n(t22.$mul(invIA, rnA), rnA)), J.$mul$n(t25.$mul(invIB, rnB), rnB));
          if (typeof $K !== "number")
            return $K.$gt();
          impulse = $K > 0 ? -$C / $K : 0;
          t1[1] = t10[1];
          ...
          t21.sub$1(t2);
          t27 = t20.angle;
          t28 = t22.$mul(invIA, t5[0] * t1[1] - t5[1] * t1[0]);
          ...
          t24.add$1(t24, t2);
          t28 = t23.angle;
          t27 = t25.$mul(invIB, t7[0] * t1[1] - t7[1] * t1[0]);
          if (typeof t27 !== "number")
            return H.iae(t27);
          t23.angle = t28 + t27;
          bodyB.synchronizeTransform$0();
  ...
  ConstantVolumeJoint: {
    ...
    static: {ConstantVolumeJoint$: function(_world, def) {
        var t1 = new V.ConstantVolumeJoint(null, null, null, null, null, 0, _world, null, null, null, def.type, null, null, new V.JointEdge(null, null, null, null), new V.JointEdge(null, null, null, null), def.bodyA, def.bodyB, false, def.collideConnected, def.userData, new T.Vector2(new Float32Array(2)), new T.Vector2(new Float32Array(2)), null, null, null, null);
  ...
  FrictionJoint: {
    ...
    solveVelocityConstraints$1: function(step) {
      ...
      Cdot.add$1(Cdot, this.bodyB.get$linearVelocity()).sub$1(this.bodyA.get$linearVelocity()).sub$1(temp);
      t3 = this.bodyA;
      t4 = t3.get$invMass();
      t5 = this.bodyB;
      t4 += t5.get$invMass();
      ...
      linearMass.invert$0();
      t2 = new Float32Array(2);
      impulse = new T.Vector2(t2);
      linearMass.transformed$2(Cdot, impulse);
      impulse.negate$0();
      oldImpulse = new T.Vector2(new Float32Array(2));
      t8 = this._linearImpulse;
      oldImpulse.setFrom$1(t8);
      t8.add$1(t8, impulse);
      maxImpulse = C.JSNumber_methods.$mul(step.dt, this._maxForce);
      if (t8.get$length2() > maxImpulse * maxImpulse) {
        t8.normalize$0();
        t8.scale$1(t8, maxImpulse);
      }
      impulse.setFrom$1(t8).sub$1(oldImpulse);
      t1 = this.bodyA;
      t3 = t1.get$linearVelocity().storage;
      t4 = t3[0];
      t5 = t2[0];
      ...
      t3[0] = t4 - t5 * t6;
      t3[1] = t3[1] - t2[1] * t6;
      t1.set$angularVelocity(t1.get$angularVelocity() - t1.invInertia * r1.cross$1(impulse));
      t1 = this.bodyB;
      t6 = t1.get$linearVelocity().storage;
      t3 = t6[0];
      t5 = t2[0];
      t4 = t1.get$invMass();
      t6[0] = t3 + t5 * t4;
      t6[1] = t6[1] + t2[1] * t4;
      t1.set$angularVelocity(t1.get$angularVelocity() + t1.invInertia * r2.cross$1(impulse));
    },
    solvePositionConstraints$1: function(baumgarte) {
      return true;
    }
    ...
    static: {Joint_Joint$create: function(argWorld, def) {
        ...
        switch (t1) {
          ...
          case 3:
            ...
            t8.setFrom$1(def.get$localAnchorA());
            t9 = new T.Vector2(new Float32Array(2));
            t9.setFrom$1(def.get$localAnchorB());
            t10 = def.get$length(def);
            return new V.DistanceJoint(t8, t9, new T.Vector2(new Float32Array(2)), 0, null, t10, def.frequencyHz, def.dampingRatio, 0, 0, t1, null, null, new V.JointEdge(null, null, null, null), new V.JointEdge(null, null, null, null), t2, t3, false, t4, t5, new T.Vector2(t6), new T.Vector2(t7), null, null, null, null);
          case 2:
            throw H.wrapException(P.UnimplementedError$(null));
          case 1:
            t2 = def.bodyA;
            ...
            t6 = new Float32Array(2);
            t7 = new Float32Array(2);
            t7 = new V.RevoluteJoint0(new T.Vector2(new Float32Array(2)), new T.Vector2(new Float32Array(2)), new T.Vector3(new Float32Array(3)), 0, new T.Matrix3(new Float32Array(9)), null, null, null, null, null, null, null, null, null, t1, null, null, new V.JointEdge(null, null, null, null), new V.JointEdge(null, null, null, null), t2, t3, false, t4, t5, new T.Vector2(t6), new T.Vector2(t7), null, null, null, null);
          ...
          case 9:
            ...
            t1.setFrom$1(def.get$localAnchorA());
            t2 = new T.Vector2(new Float32Array(2));
            t2.setFrom$1(def.get$localAnchorB());
            return new V.FrictionJoint(t1, t2, new T.Vector2(new Float32Array(2)), 0, def.get$maxForce(), def.get$maxTorque(), def.type, null, null, new V.JointEdge(null, null, null, null), new V.JointEdge(null, null, null, null), def.bodyA, def.bodyB, false, def.collideConnected, def.userData, new T.Vector2(new Float32Array(2)), new T.Vector2(new Float32Array(2)), null, null, null, null);
          case 7:
            throw H.wrapException(P.UnimplementedError$(null));
          case 6:
            throw H.wrapException(P.UnimplementedError$(null));
  ...
  RevoluteJoint0: {
    ...
    solveVelocityConstraints$1: function(step) {
      var b1, b2, v1, w1, v2, w2, m1, m2, i1, i2, t1, t2, oldImpulse, maxImpulse, imp, temp, r1, r2, t3, t4, t5, t6, t7, t8, t9, t10, t11, Cdot1, Cdot, det, $P;
      b1 = this.bodyA;
      b2 = this.bodyB;
      ...
      t3 = b1.sweep;
      t4 = b2.originTransform;
      t5 = this.localAnchor2;
      t6 = -w1;
      t7 = -w2;
      t8 = b1.originTransform;
      t9 = this.localAnchor1;
      t10 = this.mass;
      t11 = b2.sweep;
      if (t2) {
        r1.setFrom$1(t9).sub$1(t3.localCenter);
        r2.setFrom$1(t5).sub$1(t11.localCenter);
        t8.rotation.transformed$2(r1, r1);
        t4.rotation.transformed$2(r2, r2);
        t2 = new Float32Array(2);
        Cdot1 = new T.Vector2(t2);
        t3 = new Float32Array(3);
        Cdot = new T.Vector3(t3);
        V.Vector2_crossVectorAndNumToOut(r1, t6, temp);
        V.Vector2_crossVectorAndNumToOut(r2, t7, Cdot1);
        Cdot1.add$1(Cdot1, v2).sub$1(v1).sub$1(temp);
        ...
        t3[1] = -t3[1];
        t3[0] = -t3[0];
        t10.getColumn$1(1).crossInto$2(t10.getColumn$1(2), imp);
        det = t10.getColumn$1(0).dot$1(imp);
        if (det !== 0)
          det = 1 / det;
        t10.getColumn$1(1).crossInto$2(t10.getColumn$1(2), imp);
        t3 = Cdot.dot$1(imp);
        Cdot.crossInto$2(t10.getColumn$1(2), imp);
        t4 = t10.getColumn$1(0).dot$1(imp);
        t10.getColumn$1(1).crossInto$2(Cdot, imp);
        t5 = t10.getColumn$1(0).dot$1(imp);
        t2[0] = det * t3;
        t2[1] = det * t4;
        t2[2] = det * t5;
        t3 = this.limitState;
        if (t3 === 3) {
          ...
          if (t3[2] + t2[2] < 0) {
            V.Matrix3_solve22ToOut(t10, Cdot1.negate$0(), temp);
            t2[0] = t1[0];
            t2[1] = t1[1];
            t2[2] = -t3[2];
            t3[0] = t3[0] + t1[0];
        ...
        V.Vector2_crossVectorAndNumToOut(r1, t6, temp);
        V.Vector2_crossVectorAndNumToOut(r2, t7, Cdot);
        Cdot.add$1(Cdot, v2).sub$1(v1).sub$1(temp);
        V.Matrix3_solve22ToOut(t10, Cdot.negate$0(), imp);
        t10 = this.impulse.storage;
        t10[0] = t10[0] + t1[0];
        t10[1] = t10[1] + t1[1];
        t1 = temp.setFrom$1(imp);
        t1.scale$1(t1, m1);
        v1.sub$1(temp);
    ...
    solvePositionConstraints$1: function(baumgarte) {
      ...
      if ($C.get$length2() > 0.0025000000000000005) {
        ...
        if (m > 0)
          m = 1 / m;
        t8 = imp.setFrom$1($C).negate$0();
        t8.scale$1(t8, m);
        t8 = u.setFrom$1(imp);
        t8.scale$1(t8, 0.5 * invMass1);
        t7.sub$1(u);
        t8 = u.setFrom$1(imp);
        t8.scale$1(t8, 0.5 * invMass2);
        t5.add$1(t5, u);
        t8 = $C.setFrom$1(t5);
        t8.add$1(t8, r2);
        $C.sub$1(t7).sub$1(r1);
      ...
      K3.setValues$4(invI2 * t2 * t2, t10, t10, invI2 * t3 * t3);
      t3 = K1.add$1(K1, K2);
      t3.add$1(t3, K3);
      t3 = $C.negate$0();
      a11 = t9[0];
      ...
      t2 = $C.setFrom$1(imp);
      t2.scale$1(t2, b1.invMass);
      t7.sub$1($C);
      t6.angle = t6.angle - b1.invInertia * r1.cross$1(imp);
      t6 = $C.setFrom$1(imp);
      t6.scale$1(t6, b2.invMass);
      t5.add$1(t5, $C);
  ...
  World: {
    "": "Object;_flags,_contactManager,_bodyList,_jointList,_bodyCount,_jointCount,_box2d$_gravity,_allowSleep,_debugDraw,_fixtureDestructionListener,_jointDestructionListener,_pool,_inverseTimestep,_warmStarting,_continuousPhysics,_contactStacks,center,axis,timestep,cA,cB,wqwrapper,toiInput,toiOutput,backup,toiSolver,contacts,island,stack",
    ...
    solve$1: function(timeStep) {
      ...
      for (seed = this._bodyList, t2 = this._box2d$_gravity, t3 = this._allowSleep; seed != null; seed = seed.next) {
        t4 = seed.flags;
        if (typeof t4 !== "number")
          return t4.$and();
        if ((t4 & 1) === 1)
...
["vapor", "package:vapor/vapor.dart", , Q, {
  ...
  GameObject: {
    "": "Object;name,components,children,parent',scene,transform>,renderer,collider,rigidbody,camera",
    ...
    OnCollision$1: function(contact) {
      var t1, i;
      for (t1 = this.components.length, i = 0; i < t1; ++i)
        ;
    },
    static: {GameObject_CreateQuad: function() {
        var quadObject, t1, meshRenderer, mesh;
        quadObject = new Q.GameObject("GameObject", [], [], null, null, null, null, null, null, null);
        t1 = Q.Transform$();
        quadObject.transform = t1;
        quadObject.AddComponent$1(t1);
        quadObject.name = "Quad";
        meshRenderer = new Q.MeshRenderer("MeshRenderer", null, "Renderer", null, "Component", true, null);
        ...
        var circleObject, t1, meshRenderer;
        circleObject = new Q.GameObject("GameObject", [], [], null, null, null, null, null, null, null);
        t1 = Q.Transform$();
        circleObject.transform = t1;
        circleObject.AddComponent$1(t1);
  ...
  Scene: {
    "": "Object;name,gameObjects,cameras,Paused,canvas,world,_gravity",
      ...
      for (t1 = this.cameras, t2 = this.gameObjects, i = 0; i < t1.length; ++i) {
        ...
        for (j = 0; j < t2.length; ++j) {
          if (t2[j].renderer != null) {
            ...
            viewMatrix.setFrom$1(t1[i].gameObject.transform.modelMatrix);
            viewMatrix.invert$0();
            if (j >= t2.length)
              return H.ioore(t2, j);
    ...
    }, "call$1", "get$WindowResized", 2, 0, 26],
    Scene$FromCanvas$2: function(canvas, gravity) {
      var t1, t2;
      this.canvas = canvas;
      this.world = V.World$(this._gravity, true, V.DefaultWorldPool$());
      t1 = window;
      t2 = this.get$Update();
  ...
  Camera: {
    "": "Component;vapor$Camera$name,backgroundColor,fieldOfView,aspect,nearClipPlane,farClipPlane,projectionMatrix<,name,enabled,gameObject",
    Awake$0: function() {
      ...
      t5[14] = t5[11];
      t5[11] = temp;
      rotatedEye = r.$mul(r, t4.$negate(t4));
  ...
  Mesh: {
    ...
    static: {Mesh_CreateCircle: function(radius, segments, startAngle, angularSize) {
  ...
  MeshRenderer: {
    "": "Renderer;vapor$MeshRenderer$name,mesh,vapor$Renderer$name,material,name,enabled,gameObject",
    Render$0: function() {
      var t1, t2, t3, t4;
  ...
  Keyboard: {
    ...
    static: {"": "Keyboard__previousFrame,Keyboard__currentFrame,Keyboard__nextFrame", Keyboard__KeyDown: [function($event) {
      ...
      }, "call$1", "Keyboard__KeyDown$closure", 2, 0, 10], Keyboard__KeyUp: [function($event) {
        var t1 = $.get$Keyboard__nextFrame();
        t1.$indexSet(t1, J.get$keyCode$x($event), false);
      }, "call$1", "Keyboard__KeyUp$closure", 2, 0, 10]}
  },
  Mouse: {
    "": "Object;",
    Mouse$0: function() {
    ...
    static: {"": "Mouse__previousFrame,Mouse__currentFrame,Mouse__nextFrame,Mouse__nextMousePosition,Mouse_mousePosition,Mouse_deltaMousePosition", Mouse__MouseDown: [function($event) {
      ...
      }, "call$1", "Mouse__MouseDown$closure", 2, 0, 11], Mouse__MouseUp: [function($event) {
        var t1 = $.get$Mouse__nextFrame();
        t1.$indexSet(t1, J.get$button$x($event), false);
      }, "call$1", "Mouse__MouseUp$closure", 2, 0, 11], Mouse__MouseMove: [function($event) {
        var t1, t2, t3, t4;
        ...
        t2[1] = t2[1] * 2 - 1;
        t2[1] = -t2[1];
      }, "call$1", "Mouse__MouseMove$closure", 2, 0, 11]}
  },
  Touch: {
    "": "Object;",
    Touch$0: function() {
    ...
    static: {"": "Touch__previousFrame,Touch__currentFrame,Touch__nextFrame", Touch__TouchStart: [function($event) {
      ...
      }, "call$1", "Touch__TouchStart$closure", 2, 0, 12], Touch__TouchEnd: [function($event) {
      ...
      }, "call$1", "Touch__TouchEnd$closure", 2, 0, 12], Touch__TouchMove: [function($event) {
        var changedTouches, i, newTouch, j, t1, oldTouch, t2, t3, t4, t5;
        changedTouches = J.get$changedTouches$x($event);
        for (i = 0; i < changedTouches.length; ++i) {
          newTouch = changedTouches[i];
      ...
      }, "call$1", "Touch__TouchMove$closure", 2, 0, 12], Touch_Update: function() {
  ...
  Transform: {
    "": "Component;vapor$Transform$name,modelMatrix,rotation<,_eulerAngles,_scale,_scaleMatrix,name,enabled,gameObject",
    get$position: function(_) {
      var t1, t2;
    ...
    set$position: function(_, val) {
      var t1, child, t2, t3, t4;
      for (t1 = this.gameObject.children, t1 = new H.ListIterator(t1, t1.length, 0, null); t1.moveNext$0();) {
        child = t1._current;
        t2 = J.getInterceptor$x(child);
        t3 = t2.get$transform(child);
        t3.set$position(t3, val.$add(val, t2.get$transform(child).get$localPosition()));
      }
      t1 = this.modelMatrix;
      t2 = val.storage;
      t1 = t1.storage;
      ...
      t1[13] = t2[1];
      t1[14] = t2[2];
      t1 = this.gameObject.rigidbody;
      if (t1 != null && t1.body != null) {
        t1 = t1.body;
        ...
        t4[0] = t3;
        t4[1] = t2;
        t1.setTransform$2(t1, new T.Vector2(t4), this.gameObject.rigidbody.body.sweep.angle);
      }
    },
    get$localPosition: function() {
      var local, t1;
      local = this.get$position(this);
      t1 = this.gameObject.parent;
      if (t1 != null) {
        t1 = t1.transform;
        local = local.$sub(local, t1.get$position(t1));
      }
      return local;
    },
    ...
    static: {Transform$: function() {
        var t1 = new Q.Transform("Transform", null, null, null, null, null, "Component", true, null);
        t1.Transform$0();
        return t1;
      }}
  },
  BoxCollider: {
    "": "Collider;vapor$BoxCollider$name,center,size,vapor$Collider$name,attachedRigidbody,isSensor,_fixtureDef,_fixture,name,enabled,gameObject",
    Awake$0: function() {
      var shape, t1;
    ...
    Start$0: function() {
      Q.Collider.prototype.Start$0.call(this);
      this._fixture = this.attachedRigidbody.body.createFixture$1(this._fixtureDef);
    },
    Update$0: function() {
      var polygon, pos, t1, t2, t3;
      polygon = H.interceptedTypeCast(this._fixture.shape, "$isPolygonShape");
      pos = V.Transform_mul(this.attachedRigidbody.body.originTransform, polygon.centroid);
      t1 = this.gameObject.transform;
      t2 = pos.storage;
      t3 = new T.Vector3(new Float32Array(3));
      t3.setValues$3(t2[0], t2[1], t1.get$position(t1).storage[2]);
      t1.set$position(t1, t3);
      t3 = this.gameObject.transform;
      t1 = t3._eulerAngles.storage;
      t2 = new T.Vector3(new Float32Array(3));
      t2.setValues$3(t1[0], t1[1], this.attachedRigidbody.body.sweep.angle);
      t3.set$eulerAngles(t2);
    }
  },
  CircleCollider: {
    "": "Collider;vapor$CircleCollider$name,center,radius,vapor$Collider$name,attachedRigidbody,isSensor,_fixtureDef,_fixture,name,enabled,gameObject",
    Awake$0: function() {
      var shape, t1;
    ...
    Update$0: function() {
      var circle, pos, t1, t2, t3;
      circle = H.interceptedTypeCast(this._fixture.shape, "$isCircleShape");
      pos = V.Transform_mul(this.attachedRigidbody.body.originTransform, circle.position);
      t1 = this.gameObject.transform;
      t2 = pos.storage;
      t3 = new T.Vector3(new Float32Array(3));
      t3.setValues$3(t2[0], t2[1], t1.get$position(t1).storage[2]);
      ...
      t2.setValues$3(t1[0], t1[1], this.attachedRigidbody.body.sweep.angle);
      t3.set$eulerAngles(t2);
      t1 = this.attachedRigidbody.body.contactList;
  ...
  Collider: {
    ...
    Start$0: function() {
      var t1, $parent, t2;
      t1 = this.gameObject;
      this.attachedRigidbody = t1.rigidbody;
      $parent = t1.parent;
      for (; $parent != null;) {
        window;
        t1 = $.get$Console__safeConsole();
        t2 = "Parent = " + $parent.name;
        t1.toString;
        if (typeof console != "undefined")
          console.log(t2);
        t1 = $parent.rigidbody;
        if (t1 != null)
          this.attachedRigidbody = t1;
  ...
  RevoluteJoint: {
    "": "Component;vapor$RevoluteJoint$name,radius,_jointDef,enableMotor,connectedRigidBody,anchor,_revoluteJoint,name,enabled,gameObject",
    Awake$0: function() {
      var t1, t2;
      t1 = new Float32Array(2);
      t1[0] = 0;
      ...
      t2[0] = 0;
      t2[1] = 0;
      t2 = new V.RevoluteJointDef(new T.Vector2(t1), new T.Vector2(t2), 0, false, 0, 0, false, 0, 0, 0, null, null, null, false);
      t2.RevoluteJointDef$0();
      this._jointDef = t2;
      t2.enableMotor = this.enableMotor;
    },
    Start$0: function() {
      var t1, t2, t3, t4;
      t1 = this._jointDef;
      t2 = this.gameObject.rigidbody.body;
      t3 = this.connectedRigidBody.body;
      t4 = this.anchor;
      t1.bodyA = t2;
      t1.bodyB = t3;
      t2.getLocalPointToOut$2(t4, t1.localAnchorA);
      t1.bodyB.getLocalPointToOut$2(t4, t1.localAnchorB);
      t1.referenceAngle = t1.bodyA.get$angle() - t1.bodyB.get$angle();
      this._revoluteJoint = this.gameObject.scene.world.createJoint$1(this._jointDef);
    },
    Update$0: function() {
      return;
    }
  ...
  RigidBody: {
    "": "Component;vapor$RigidBody$name,body>,_bodyType,_bodyDef,name,enabled,gameObject",
    Awake$0: function() {
      var t1, t2, t3, t4;
      t1 = new V.BodyDef(0, 0, null, new T.Vector2(new Float32Array(2)), new T.Vector2(new Float32Array(2)), 0, false, null, false, true, 0, 0, true, true);
      this._bodyDef = t1;
      t1.type = this._bodyType;
      t2 = this.gameObject.transform;
    ...
    Start$0: function() {
      ...
      t4[0] = t3;
      t4[1] = t2;
      t1.setTransform$2(t1, new T.Vector2(t4), this.gameObject.transform._eulerAngles.storage[2]);
    },
    $isRigidBody: true
  }
}],
["vector_math", "package:vector_math/vector_math.dart", , T, {
  ...
  Matrix3: {
    ...
    transform$1: [function(_, arg) {
      ...
      t12 = t1[5];
      t1 = t1[8];
      t13 = J.getInterceptor$x(arg);
      t13.set$x(arg, t2 * t5 + t6 * t7 + t8 * t3);
      t13.set$y(arg, t4 * t5 + t9 * t7 + t10 * t3);
      t13.set$z(arg, t11 * t5 + t12 * t7 + t1 * t3);
      return arg;
    }, "call$1", "get$transform", 2, 0, 28]
  },
  Matrix4: {
    "": "Object;storage<",
    setFrom$1: function(arg) {
  ...
  Vector4: {
    ...
    $negate: function(_) {
      ...
      t2.setValues$4(-t1[0], -t1[1], -t1[2], -t1[3]);
      return t2;
    },
    $sub: function(_, other) {
      var t1, t2, t3, t4, t5, t6, t7, t8, t9;
...
Isolate.$lazy($, "CornflowerBlue", "Color_CornflowerBlue", "get$Color_CornflowerBlue", function() {
  var t1 = new T.Vector4(new Float32Array(4));
  t1.setValues$4(0.39215686274509803, 0.5843137254901961, 0.9294117647058824, 1);
  return t1;
});
...
{func: "Vector2__Vector2", ret: T.Vector2, args: [T.Vector2]},
{func: "Vector3__Vector3", ret: T.Vector3, args: [T.Vector3]},
{func: "Vector4__Vector4", ret: T.Vector4, args: [T.Vector4]},
];
$ = null;
...
function dart_precompiled($collectedClasses) {
  ...
  GraphicsElement.prototype.get$transform = function(receiver) {
  ...
  function Car(distance, maxDistance, name, enabled, gameObject) {
  ...
  if (!"name" in Car)
    Car.name = "Car";
  $desc = $collectedClasses.Car;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Car.prototype = $desc;
  function FollowObject(target, name, enabled, gameObject) {
    this.target = target;
    this.name = name;
    this.enabled = enabled;
    this.gameObject = gameObject;
  }
  FollowObject.builtin$cls = "FollowObject";
  if (!"name" in FollowObject)
    FollowObject.name = "FollowObject";
  $desc = $collectedClasses.FollowObject;
  if ($desc instanceof Array)
    $desc = $desc[1];
  FollowObject.prototype = $desc;
  ...
  DynamicTreeNode.prototype.set$childOne = function(v) {
    return this.childOne = v;
  };
  ...
  function Transform0(position, rotation) {
    this.position = position;
  ...
  Transform0.prototype.get$position = function(receiver) {
    return this.position;
  };
  ...
  function RevoluteJoint0(localAnchor1, localAnchor2, impulse, _motorImpulse, mass, motorMass, _enableMotor, _maxMotorTorque, _motorSpeed, _enableLimit, referenceAngle, lowerAngle, upperAngle, limitState, type, _prev, _next, edgeA, edgeB, bodyA, bodyB, islandFlag, collideConnected, userData, localCenterA, localCenterB, invMassA, invIA, invMassB, invIB) {
    this.localAnchor1 = localAnchor1;
    this.localAnchor2 = localAnchor2;
    this.impulse = impulse;
  ...
  RevoluteJoint0.builtin$cls = "RevoluteJoint0";
  if (!"name" in RevoluteJoint0)
    RevoluteJoint0.name = "RevoluteJoint0";
  $desc = $collectedClasses.RevoluteJoint0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  RevoluteJoint0.prototype = $desc;
  RevoluteJoint0.prototype.get$mass = function() {
    return this.mass;
  };
  ...
  function World(_flags, _contactManager, _bodyList, _jointList, _bodyCount, _jointCount, _box2d$_gravity, _allowSleep, _debugDraw, _fixtureDestructionListener, _jointDestructionListener, _pool, _inverseTimestep, _warmStarting, _continuousPhysics, _contactStacks, center, axis, timestep, cA, cB, wqwrapper, toiInput, toiOutput, backup, toiSolver, contacts, island, stack) {
    this._flags = _flags;
    ...
    this._box2d$_gravity = _box2d$_gravity;
  ...
  function GameObject(name, components, children, parent, scene, transform, renderer, collider, rigidbody, camera) {
    this.name = name;
  ...
  GameObject.prototype.set$parent = function(receiver, v) {
    return this.parent = v;
  };
  GameObject.prototype.get$transform = function(receiver) {
    return this.transform;
  };
  function Scene(name, gameObjects, cameras, Paused, canvas, world, _gravity) {
    this.name = name;
  ...
  function Camera(vapor$Camera$name, backgroundColor, fieldOfView, aspect, nearClipPlane, farClipPlane, projectionMatrix, name, enabled, gameObject) {
  ...
  if ($desc instanceof Array)
    $desc = $desc[1];
  Mesh.prototype = $desc;
  function MeshRenderer(vapor$MeshRenderer$name, mesh, vapor$Renderer$name, material, name, enabled, gameObject) {
  ...
  function Transform(vapor$Transform$name, modelMatrix, rotation, _eulerAngles, _scale, _scaleMatrix, name, enabled, gameObject) {
    this.vapor$Transform$name = vapor$Transform$name;
  ...
  function BoxCollider(vapor$BoxCollider$name, center, size, vapor$Collider$name, attachedRigidbody, isSensor, _fixtureDef, _fixture, name, enabled, gameObject) {
  ...
  function CircleCollider(vapor$CircleCollider$name, center, radius, vapor$Collider$name, attachedRigidbody, isSensor, _fixtureDef, _fixture, name, enabled, gameObject) {
  ...
  function RevoluteJoint(vapor$RevoluteJoint$name, radius, _jointDef, enableMotor, connectedRigidBody, anchor, _revoluteJoint, name, enabled, gameObject) {
    this.vapor$RevoluteJoint$name = vapor$RevoluteJoint$name;
    this.radius = radius;
    this._jointDef = _jointDef;
    this.enableMotor = enableMotor;
    this.connectedRigidBody = connectedRigidBody;
    this.anchor = anchor;
    this._revoluteJoint = _revoluteJoint;
    this.name = name;
    this.enabled = enabled;
    this.gameObject = gameObject;
  }
  ...
  function RigidBody(vapor$RigidBody$name, body, _bodyType, _bodyDef, name, enabled, gameObject) {
    this.vapor$RigidBody$name = vapor$RigidBody$name;
    this.body = body;
  ...
  RigidBody.builtin$cls = "RigidBody";
  if (!"name" in RigidBody)
    RigidBody.name = "RigidBody";
  $desc = $collectedClasses.RigidBody;
  if ($desc instanceof Array)
    $desc = $desc[1];
  RigidBody.prototype = $desc;
  RigidBody.prototype.get$body = function(receiver) {
    return this.body;
  };
